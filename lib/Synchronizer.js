  ...
  constructor() {
    ...
    this.remoteInternal = () => {
      ...
      if (storage.session.isPackSynchronizing) {
        ...
        net.broadcast(CmdPacker.pack(CmdPacker.CMD_REQUEST_BLOCKS_AFTER, {flags: [CmdPacker.FLAG_ZIP_ALLOWED], hash: lastHash, count: 128}), true, storage.session.syncSpeed)
      } else {
    ...
    net.on('multipartRcvdFirst', (multipartId, data, callback) => {
      ...
      if (data[0] === CmdPacker.CMD_TAKE_BLOCKS_AFTER) {
