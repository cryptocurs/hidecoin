  ...
  constructor() {
    ...
    this.boxes = {
      header: blessed.box({
        ...
        content: '{bold}HPS    0 RPS    0 BLK        0 SNC 1{/bold}',
        tags: true,
        style: {
          fg: 'white',
          bg: 'cyan',
    ...
    storage.on('stat', (data) => {
      ...
      this.boxes.header.setLine(0, '{bold}HPS ' + _.padStart(this.stat.hps, 4) + ' RPS ' + _.padStart(this.stat.rps, 4) + ' BLK ' + _.padStart(this.stat.blk, 8) + ' SNC ' + this.stat.snc + '{/bold}')
      this.screen.render()
    })
  }
