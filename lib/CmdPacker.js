...
module.exports = {
  pack: (cmd, data) => {
    ...
    if (cmd === CMD_SRV_INFO) {
      ...
      packet.packFixed(data.hash).packNumber(data.count, 1)
      ...
      packet.packFixed(data.afterHash)
      R.forEach((block) => {
